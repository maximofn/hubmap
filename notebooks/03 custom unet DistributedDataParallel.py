...
def train(rank, world_size):
    ...
    dataloader = {
        'train': torch.utils.data.DataLoader(dataset['train'], batch_size=BS_train, shuffle=False, pin_memory=True, sampler=sampler['train']),
        'test':  torch.utils.data.DataLoader(dataset['val'],   batch_size=BS_val,   shuffle=False, pin_memory=True, sampler=sampler['val'])
    }
...
def main():
    ...
    fn = train
    mp.spawn(fn, args=(word_size,), nprocs=word_size)
